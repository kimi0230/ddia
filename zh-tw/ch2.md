...
[TOC]
- [第二章：資料模型與查詢語言](#第二章資料模型與查詢語言)
  - [關係模型與文件模型](#關係模型與文件模型)
    - [NoSQL 的誕生](#nosql-的誕生)
    - [物件關係不匹配](#物件關係不匹配)
    - [多對一和多對多的關係](#多對一和多對多的關係)
    - [文件資料庫是否在重蹈覆轍？](#文件資料庫是否在重蹈覆轍)
      - [網狀模型](#網狀模型)
      - [關係模型](#關係模型)
      - [與文件資料庫相比](#與文件資料庫相比)
    - [關係型資料庫與文件資料庫在今日的對比](#關係型資料庫與文件資料庫在今日的對比)
      - [哪種資料模型更有助於簡化應用程式碼？](#哪種資料模型更有助於簡化應用程式碼)
      - [文件模型中的模式靈活性](#文件模型中的模式靈活性)
      - [查詢的資料區域性](#查詢的資料區域性)
      - [文件和關係資料庫的融合](#文件和關係資料庫的融合)
  - [資料查詢語言](#資料查詢語言)
    - [Web 上的宣告式查詢](#web-上的宣告式查詢)
    - [MapReduce查詢](#mapreduce查詢)
  - [圖資料模型](#圖資料模型)
    - [屬性圖](#屬性圖)
    - [Cypher 查詢語言](#cypher-查詢語言)
    - [SQL 中的圖查詢](#sql-中的圖查詢)
    - [三元組儲存和 SPARQL](#三元組儲存和-sparql)
      - [語義網](#語義網)
      - [RDF 資料模型](#rdf-資料模型)
    - [SPARQL 查詢語言](#sparql-查詢語言)
    - [基礎：Datalog](#基礎datalog)
  - [本章小結](#本章小結)
  - [參考文獻](#參考文獻)
