...
[TOC]
- [第三章：儲存與檢索](#第三章儲存與檢索)
  - [驅動資料庫的資料結構](#驅動資料庫的資料結構)
    - [雜湊索引](#雜湊索引)
    - [SSTables和LSM樹](#sstables和lsm樹)
      - [構建和維護SSTables](#構建和維護sstables)
      - [用SSTables製作LSM樹](#用sstables製作lsm樹)
      - [效能最佳化](#效能最佳化)
    - [B樹](#b樹)
      - [讓B樹更可靠](#讓b樹更可靠)
      - [B樹的最佳化](#b樹的最佳化)
  ...
  - [事務處理還是分析？](#事務處理還是分析)
    - [資料倉庫](#資料倉庫)
      - [OLTP資料庫和資料倉庫之間的分歧](#oltp資料庫和資料倉庫之間的分歧)
    - [星型和雪花型：分析的模式](#星型和雪花型分析的模式)
  - [列式儲存](#列式儲存)
    - [列壓縮](#列壓縮)
      - [記憶體頻寬和向量化處理](#記憶體頻寬和向量化處理)
    - [列式儲存中的排序順序](#列式儲存中的排序順序)
      - [幾個不同的排序順序](#幾個不同的排序順序)
    - [寫入列式儲存](#寫入列式儲存)
    - [聚合：資料立方體和物化檢視](#聚合資料立方體和物化檢視)
  - [本章小結](#本章小結)
  - [參考文獻](#參考文獻)
