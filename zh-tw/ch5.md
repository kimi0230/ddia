...
- [第五章：複製](#第五章複製)
  - [領導者與追隨者](#領導者與追隨者)
    ...
    - [複製日誌的實現](#複製日誌的實現)
      - [基於語句的複製](#基於語句的複製)
      - [傳輸預寫式日誌（WAL）](#傳輸預寫式日誌wal)
      - [邏輯日誌複製（基於行）](#邏輯日誌複製基於行)
      - [基於觸發器的複製](#基於觸發器的複製)
  - [複製延遲問題](#複製延遲問題)
    - [讀己之寫](#讀己之寫)
    - [單調讀](#單調讀)
  ...
  - [多主複製](#多主複製)
    - [多主複製的應用場景](#多主複製的應用場景)
      - [運維多個數據中心](#運維多個數據中心)
      - [需要離線操作的客戶端](#需要離線操作的客戶端)
      - [協同編輯](#協同編輯)
    - [處理寫入衝突](#處理寫入衝突)
      - [同步與非同步衝突檢測](#同步與非同步衝突檢測)
      - [避免衝突](#避免衝突)
      - [收斂至一致的狀態](#收斂至一致的狀態)
      - [自定義衝突解決邏輯](#自定義衝突解決邏輯)
      - [什麼是衝突？](#什麼是衝突)
    - [多主複製拓撲](#多主複製拓撲)
  - [無主複製](#無主複製)
    - [當節點故障時寫入資料庫](#當節點故障時寫入資料庫)
      - [讀修復和反熵](#讀修復和反熵)
      - [讀寫的法定人數](#讀寫的法定人數)
    - [法定人數一致性的侷限性](#法定人數一致性的侷限性)
      - [監控陳舊度](#監控陳舊度)
    - [寬鬆的法定人數與提示移交](#寬鬆的法定人數與提示移交)
      - [運維多個數據中心](#運維多個數據中心-1)
    - [檢測併發寫入](#檢測併發寫入)
      - [最後寫入勝利（丟棄併發寫入）](#最後寫入勝利丟棄併發寫入)
      - [“此前發生”的關係和併發](#此前發生的關係和併發)
      - [捕獲"此前發生"關係](#捕獲此前發生關係)
      - [合併併發寫入的值](#合併併發寫入的值)
      - [版本向量](#版本向量)
  - [本章小結](#本章小結)
